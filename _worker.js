...
let urls = [];
let subConverter = "https://tools.huanghaiwan.com/api/convert?url=...&target=clash&emoji=1"; //在线订阅转换后端，目前使用CM的订阅转换功能。支持自建psub 可自行搭建https://github.com/bulianglin/psub
